...
ProportionTeller_input_path = home_directory + '/Input_Files'
ProportionTeller_html_path = home_directory + '/HTML_Files/'
ProportionTeller_working_directory = home_directory + '/Working_Directory'
ProportionTeller_output_path = home_directory + '/Output_Files'
ProportionTeller_reference_files_path = home_directory + '/Reference_Files'


if os.path.exists(home_directory) is False:
   os.mkdir(home_directory)

if os.path.exists(ProportionTeller_html_path) is False:
   os.mkdir(ProportionTeller_html_path)
...
if os.path.exists(ProportionTeller_reference_files_path) is False:
   os.mkdir(ProportionTeller_reference_files_path)

if os.path.exists(ProportionTeller_working_directory) is False:
    os.mkdir(ProportionTeller_working_directory)

screen_experimental_against_control(ProportionTeller_input_path,ProportionTeller_working_directory)
...
ptm_modifier_file = ProportionTeller_input_path + '/User_Response_File.txt'
...
Zero_PTMs_File = open(ProportionTeller_output_path +'/Zero_PTMs', 'w')
One_PTM_File = open(ProportionTeller_output_path +'/One_PTM', 'w')
Multiple_PTMs_File = open(ProportionTeller_output_path +'/Multiple_PTMs', 'w')
# requested_residue_unmodified_file = open(ProportionTeller_output_path +'/Unphosphorylated_Tyrosines.csv', 'w')
# ProportionTeller_files_string = '/' + requested_kinase + '_' + 'N' + '_' + str(requested_replicate) + '_'
# pos_peaks_file = ProportionTeller_input_path + ProportionTeller_files_string + 'protein-peptides.csv'
pos_peaks_file = ProportionTeller_input_path + 'Post_Control_Filter.csv'
fasta_file = ProportionTeller_reference_files_path +'/FASTA_File.csv'
trypsinized_assay_file = ProportionTeller_output_path + '/Trypsinized_UniProt.csv'
screened_peaks_file = ProportionTeller_output_path +'/Screened_PEAKS_File.csv'
...
#    neg_peaks_file = ProportionTeller_input_path + neg_portionteller_files_string + 'protein-peptides.csv'
#    pos_portionteller_files_string = '/' + requested_kinase + '/' + requested_kinase + '_PLUS_' + requested_replicate + '_'
#    pos_peaks_file = ProportionTeller_input_path + pos_portionteller_files_string + 'protein-peptides.csv'
...
accession_numbers_file = create_accession_numbers_file(ProportionTeller_working_directory)
